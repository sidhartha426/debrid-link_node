...
const showFiles = (torrents, indexes, showURL) => {
  indexes.forEach((index) => {
    console.log(index + 1, "Torrent Name: ", torrents[index].name, "\n\n");
...
const manipulateTorrents = async (torrents) => {
  ...
  const processInput = async (operations, resolve) => {
    ...
    //Check if Downloaded  by the user
...
exports.showTorrents = showTorrents;
exports.getPercentage = getPercentage;
exports.checkCompleted = checkCompleted;
exports.countCompleted = countCompleted;
exports.torrentNameFilter = torrentNameFilter;
exports.torrentFileNameFilter = torrentFileNameFilter;
exports.torrentFilePercentFilter = torrentFilePercentFilter;
exports.manipulateTorrents = manipulateTorrents;
exports.manipulateTorrentFiles = manipulateTorrentFiles;
